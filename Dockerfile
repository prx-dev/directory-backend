...
ARG JAR_FILE=directory-backend.jar
...
EXPOSE 8197
CMD ["java", "-Dspring.application.name=directory-backend", "-Dspring.cloud.vault.enabled=${VAULT_ENABLED}", "-Dapi.info.version=1.0.0", "-jar", "directory-backend.jar"]

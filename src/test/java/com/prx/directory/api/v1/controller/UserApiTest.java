...
class UserApiTest {
    ...
    @Test
    @DisplayName("createUser should return BAD_REQUEST status with null username")
    void createUserShouldReturnBadRequestStatusWithNullUsername() {
    ...
    @Test
    @DisplayName("createUser should return BAD_REQUEST status with null password")
    void createUserShouldReturnBadRequestStatusWithNullPassword() {
    ...
    @Test
    @DisplayName("createUser should return BAD_REQUEST status with null email")
    void createUserShouldReturnBadRequestStatusWithNullEmail() {
